...
The default Jest coverage configuration can be overriden by adding any of the following supported keys to a Jest index in your package.json.
...
[`webpack.index.prod.js`](../config/webpack.config.prod.js).
